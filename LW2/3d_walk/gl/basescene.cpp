...
void BaseScene::setViewport(QSize viewport)
{
    ...
    m_viewController.setViewport(viewport);
...
void BaseScene::switchCameras()
{
    m_viewController.switchCameras();
}

ISceneCamera &BaseScene::camera()
{
    return m_viewController.camera();
}

const ISceneCamera &BaseScene::camera() const
{
    return m_viewController.camera();
}
